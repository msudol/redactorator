...
class TestSsnRegex(PrettyTestCase):
    ...
    # Verify labeled SSN formats are detected (various label styles)
    ...
    # Ensure similar-looking numbers or unrelated labels don't trigger SSN
    ...
    # Aggressive mode should match unlabeled SSN numbers
    ...
    # Strict mode requires explicit SSN labels and should not match raw numbers
    ...
    # Redaction should preserve the SSN label and only mask the number
    ...
    # redact_all should apply multiple group redactions in order
